...
public class SortingMethod
{
    ...
    private readonly Sorter<CharacterGridItemModel> _sorter;

    private readonly CharacterGridItemModel[] _lastCharacters;
    private readonly CharacterGridItemModel? _firstCharacter;

    public SortingMethod(Sorter<CharacterGridItemModel> sortingMethodType, CharacterGridItemModel? firstCharacter = null,
